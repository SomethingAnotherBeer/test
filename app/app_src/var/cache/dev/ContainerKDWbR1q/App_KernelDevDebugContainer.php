...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\NumberController' => 'getNumberControllerService',
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('console.error', [0 => #[\Closure(name: 'App\\EventListener\\ConsoleErrorListener')] function () {
            return ($this->privates['App\\EventListener\\ConsoleErrorListener'] ?? ($this->privates['App\\EventListener\\ConsoleErrorListener'] = new \App\EventListener\ConsoleErrorListener()));
        }, 1 => 'onConsoleError'], 0);
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('yJUNN2Dix6', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
